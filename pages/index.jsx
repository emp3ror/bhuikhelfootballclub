...
export default function Index({ posts, globalData }) {
  ...
  return (
    <>
      ...
      <main className="w-full pt-20 pb-12 banner">
      ...
      <div className='background text-center'>
        ...
        <a href="/tournament" class="button-banner inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
          ...
          <span class="w-full">Tournament</span>
